...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-gray-500 text-sm">Registros de salidas de stock hacia sucursales o agentes.</p>
        </div>
        <div class="flex gap-3">
            <a href="registrar" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm">
                <i class="fa-solid fa-plus"></i> Registrar Salida
            </a>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                <?php foreach ($salidas as $s): ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4"><span class="font-mono text-blue-600 bg-blue-50 px-2.5 py-1 rounded text-xs font-medium border border-blue-100"><?php echo $s['id']; ?></span></td>
                        <td class="px-6 py-4 font-medium text-gray-900"><?php echo $s['producto']; ?></td>
                        <td class="px-6 py-4"><?php echo $s['cantidad']; ?></td>
                        <td class="px-6 py-4"><?php echo $s['destino']; ?></td>
                        <td class="px-6 py-4"><?php echo $s['fecha']; ?></td>
                        <td class="px-6 py-4"><?php echo $s['solicitado_por']; ?></td>
                        <td class="px-6 py-4">
    ...
    <div class="flex justify-between items-center mt-6 pt-6 border-t border-gray-100">
        <span class="text-sm text-gray-500">Mostrando <span class="text-gray-900 font-medium">1-3</span> de <span class="text-gray-900 font-medium">3</span> salidas</span>
        <div class="flex items-center gap-2">
